...
![](data/resultsummary.png){#fig-results-summary}
...
::: {#fig-tokenisation layout-ncol="2"}
```{r}
#| label: fig-unigram
abstract_unigrams_clean %>% 
  group_by(type) %>%
