...
Topics containing study terminology were common to both corpuses, however, the unigram '*placebo*' was unique to the later corpus ([@fig-post-leca-lda]). The frequency of the trigram '*randomised controlled trials*' was greater in the later corpus ([@fig-trigram]), despite fewer abstracts being in this dataset ([@fig-results-summary]). This could suggest an increase in the number of randomised clinical trials (RCT) after lecanemab received accelerated approval . Placebos are used when there is no known or FDA-approved therapy that can be tolerated by patients, therefore as AD does not have a standard of care treatment to cure the disease, a placebo may be used in RCTs. This is consistent with the trends observed in Huang *et al* [@Huang2023-vq], which suggested an increase in Phase III clinical trials for anti-amyloid therapies in 2023 which encompassed the traditional approval date of lecanemab by the FDA in July 2023 from the CLARITY AD clinical trial [@Office_of_the_Commissioner2023-ka].
