...
We found the unigrams ‘*covid*’ and ‘*19*’ were unique only to the earlier LDA model, despite ‘*covid* *19’* and ‘*sars cov 2*’ being among the most frequent bigrams and trigrams in both corpuses ([@fig-topic-model-unigrams; @fig-bigram; @fig-trigram]), however this might be a consequence of the larger volume of COVID-19-related research published during the post-pandemic years. Research has shown higher immune cell CSF proinflammatory cytokines and reduced amyloid processing in patients with COVID-19 neurological disease [@Ziff2022-qh], therefore research themes may be shifting to explore inflammatory causes of AD.

## ‘*Study Terminology’* and ‘*Treatments*’ 

Topics containing '*study terminology'* were common to both LDA models, however, the unigram ‘*placebo*’ was unique to the later model ([@fig-post-leca-lda]). The trigram, ‘*randomised controlled trials’,* was more frequent in the later corpus which could suggest an increase in the number of randomised clinical trials (RCT) after lecanemab received accelerated approval ([@fig-trigram]). Placebos are used when there is no known or FDA-approved therapy that can be tolerated by patients, therefore, as AD does not have a standard of care treatment, a placebo may be used for comparison in RCTs. Trends in Huang *et al* [@Huang2023-vq], suggested an increase in Phase III clinical trials for anti-amyloid therapies in 2023 which encompassed the traditional approval date of lecanemab by the FDA in July 2023 from the CLARITY AD clinical trial [@Office_of_the_Commissioner2023-ka]. Previous text mining analysis in AD research has identified clinical outcomes [@Martinelli2022-ic], however, literature concerning RCTs and placebo-controlled trials was unique to our analysis.

Topic discussing '*drug discover*y' and '*trial types'* were unique to the earlier LDA model and encompassed unigrams from pre-clinical studies, ‘*cells*’ and ‘*models*’, and clinical studies, ‘*trial*’, ‘*human*’ (\[@fig-pre-leca-lda\]). There was an increase in the number of topics relating to '*treatments'* and the beta-value for the terms ’*tau*’, ’*amyloid*’, and ‘*aβ*’ in the topic concerning '*molecular pathology',* in the LDA model after the accelerated approval of lecanemab ([@fig-post-leca-lda]). Clinical trials including disease-modifying therapies targeting tau have increased with 14 active trials at the beginning of 2023 [@Cummings2023-lo], therefore research may be shifting to identify drugs which target the tau hypothesis for AD as well as current anti-amyloid therapies like lecanemab.
