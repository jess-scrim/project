...
The distribution of publications containing the terms associated with 'lecanemab' is shown below:

```{r}
# Results from Lecanemab PubMed search
...
Pre-leca LDA Topic Model Bigrams
...
Post-leca LDA Topic Model Bigrams
